...
namespace itemlist
{
    ...
    const auto skills =
    {
        "SkillCard_DarkLaser|Dark: Dark Laser",
        "SkillCard_ShadowBall|Dark: Nightmare Ball",
        "SkillCard_PoisonShot|Dark: Poison Blast",
        "SkillCard_Psychokinesis|Dark: Psycho Gravity",
        "SkillCard_DarkWave|Dark: Shadow Burst",
        "SkillCard_GhostFlame|Dark: Spirit Flame",
        "SkillCard_DragonBreath|Dragon: Draconic Breath",
        "SkillCard_DragonWave|Dragon: Dragon Burst",
        "SkillCard_DragonCanon|Dragon: Dragon Cannon",
        "SkillCard_DragonMeteor|Dragon: Dragon Meteor",
        "SkillCard_RockLance|Earth: Rock Lance",
        "SkillCard_MudShot|Earth: Sand Blast",
        "SkillCard_SandTornado|Earth: Sand Tornado",
        "SkillCard_StoneShotgun|Earth: Stone Blast",
        "SkillCard_ThrowRock|Earth: Stone Cannon",
        "SkillCard_ThunderBall|Electric: Electric Ball",
        "SkillCard_Thunderbolt|Electric: Lightning Bolt",
        "SkillCard_LineThunder|Electric: Lightning Streak",
        "SkillCard_LightningStrike|Electric: Lightning Strike",
        "SkillCard_LockonLaser|Electric: Lock-on Laser",
        "SkillCard_ThunderFunnel|Electric: Plasma Tornado",
        "SkillCard_ElecWave|Electric: Shockwave",
        "SkillCard_SpreadPulse|Electric: Spark Blast",
        "SkillCard_ThreeThunder|Electric: Tri-Lightning",
        "SkillCard_FireBall|Fire: Fire Ball",
        "SkillCard_FlareArrow|Fire: Flare Arrow",
        "SkillCard_FlareTornado|Fire: Flare Storm",
        "SkillCard_FireBlast|Fire: Ignis Blast",
        "SkillCard_Flamethrower|Fire: Ignis Breath",
        "SkillCard_Inferno|Fire: Ignis Rage",
        "SkillCard_FireSeed|Fire: Spirit Fire",
        "SkillCard_GrassTornado|Grass: Grass Tornado",
        "SkillCard_SeedMachinegun|Grass: Seed Machine Gun",
        "SkillCard_SeedMine|Grass: Seed Mine",
        "SkillCard_SolarBeam|Grass: Solar Blast",
        "SkillCard_RootAttack|Grass: Spine Vine",
        "SkillCard_WindCutter|Grass: Wind Cutter",
        "SkillCard_IcicleThrow|Ice: Blizzard Spike",
        "SkillCard_FrostBreath|Ice: Cryst Breath",
        "SkillCard_BlizzardLance|Ice: Iceberg",
        "SkillCard_IceBlade|Ice: Icicle Cutter",
        "SkillCard_IceMissile|Ice: Ice Missile",
        "SkillCard_AirCanon|Neutral: Air Cannon",
        "SkillCard_SelfDestruct|Neutral: Implode",
        "SkillCard_HyperBeam|Neutral: Pal Blast",
        "SkillCard_PowerBall|Neutral: Power Bomb",
        "SkillCard_PowerShot|Neutral: Power Shot",
        "SkillCard_AcidRain|Water: Acid Rain",
        "SkillCard_WaterBall|Water: Aqua Burst",
    ...
    const auto saddles =
    {
        "SkillUnlock_Alpaca|Melpaca",
        "SkillUnlock_AmaterasuWolf|Kitsun",
        //"SkillUnlock_BadCatgirl",
        "SkillUnlock_BirdDragon|VanywrmSaddle",
        "SkillUnlock_BlackCentaur|Necromus Saddle",
        "SkillUnlock_BlackFurDragon|Dragostophe's Shotgun",
        ...
        //"SkillUnlock_Boar|Rushboar",
        "SkillUnlock_CaptainPenguin|Penking",
        ...
        "SkillUnlock_ElecPanda|Grizzbolt's Machine Gun",
        ...
        "SkillUnlock_FlyingManta|Celeray's Gloves",
        "SkillUnlock_Garm|Direhowl's Saddled Harness",
        "SkillUnlock_GhostBeast|Mariath Saddle",
        //"SkillUnlock_GoldenHorse",
        "SkillUnlock_GrassMammoth|Mammorest Saddle",
        "SkillUnlock_GrassPanda|Moassanda's Grenade Launcher",
        ...
        "SkillUnlock_JetDragon|Jetragon's Missle Launcher",
        "SkillUnlock_KingAlpaca|Kingpaca Saddle",
        "SkillUnlock_KingBahamut|Blazamut Saddle",
        "SkillUnlock_Kirin|Univolt Saddle",
        "SkillUnlock_Kitsunebi|Foxpark's Harness",
        "SkillUnlock_LazyDragon|Relaxaurus's Missle Launcher",
        //"SkillUnlock_LilyQueen",
        "SkillUnlock_Manticore|Blazehowl Saddle",
        "SkillUnlock_Monkey|Tamzee's Assault Rifle",
        ...
        "SkillUnlock_Deer_Ground|Eikthyrdeer Tera Saddle",
        ...
        "SkillUnlock_LazyDragon_Electric|Relaxaurus Lux's Missle Launcher",
