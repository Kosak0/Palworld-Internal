    ...
    namespace Styles 
    {
        void InitStyle()
        {
            ...
            else 
            {
                ...
                colors[ImGuiCol_TextDisabled] = ImVec4(0.30f, 0.30f, 0.32f, 1.00f);
                ...
                colors[ImGuiCol_FrameBgActive] = ImVec4(0.55f, 0.56f, 0.58f, 1.00f);
                ...
                colors[ImGuiCol_CheckMark] = ImVec4(0.85f, 0.12f, 0.15f, 0.80f);
                colors[ImGuiCol_SliderGrab] = ImVec4(0.70f, 0.10f, 0.12f, 0.60f);
                colors[ImGuiCol_SliderGrabActive] = ImVec4(0.85f, 0.12f, 0.15f, 1.00f);
                colors[ImGuiCol_Button] = ImVec4(0.17f, 0.17f, 0.19f, 1.00f);
                colors[ImGuiCol_ButtonHovered] = ImVec4(0.85f, 0.12f, 0.15f, 1.00f);
                colors[ImGuiCol_ButtonActive] = ImVec4(0.85f, 0.12f, 0.15f, 1.00f);
                ...
                colors[ImGuiCol_TabActive] = ImVec4(1.00f, 0.15f, 0.15f, 1.00f);
                colors[ImGuiCol_TabHovered] = ImVec4(1.00f, 0.15f, 0.15f, 1.00f);
