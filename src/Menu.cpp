    ...
    namespace Styles 
    {
        void InitStyle()
        {
            ...
            else 
            {
                ...
                //colors[ImGuiCol_ChildWindowBg] = ImVec4(0.00f, 0.00f, 0.00f, 1.00f);
                ...
                //colors[ImGuiCol_ComboBg] = ImVec4(0.24f, 0.24f, 0.24f, 0.99f);
                ...
                //colors[ImGuiCol_CloseButton] = ImVec4(0.45f, 0.45f, 0.45f, 0.50f);
